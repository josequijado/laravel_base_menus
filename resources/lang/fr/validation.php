...
return [
    ...
    */
    ...
    'confirmed'            => 'Le confirmation de ce champ ne correspond pas.',
    ...
    'gt'                   => [
        ...
        'string'  => 'Le texte ce champ doit contenir plus de :value caractères.',
        'array'   => 'Le tableau ce champ doit contenir plus de :value éléments.',
    ],
    'gte'                  => [
    ...
    'in_array'             => "Cette valeur n'est pas autorisée.",
    ...
    'lt'                   => [
        ...
        'string'  => 'Le texte ce champ doit contenir moins de :value caractères.',
        'array'   => 'Le tableau ce champ doit contenir moins de :value éléments.',
    ],
    'lte'                  => [
        ...
        'array'   => 'Ce champ doit contenir au plus :value éléments.',
    ],
    'max'                  => [
        ...
        'string'  => 'Le texte de ce champ ne peut contenir plus de :max caractères.',
        'array'   => 'Ce champ ne peut contenir plus de :max éléments.',
    ],
    ...
    'not_regex'            => "Le format du ce champ n'est pas valide.",
    'numeric'              => 'Ce champ doit contenir un nom.',
    'present'              => 'Ce champ doit être présent.',
    'regex'                => 'Le format du ce champ est invalide.',
